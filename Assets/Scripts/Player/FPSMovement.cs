...
public class FPSMovement : MonoBehaviour
{
    ...
    private void Update() // Передвижение
    {
        ...
        if (_characterController.isGrounded) // Определяем соприкосновение с землей
        {
            _velocity.y = 0; 
            ...
            // Проверка, активен ли джетпак
            if (_jetpack != null && _jetpack.IsJetpackActive)
            {
                _jetpack.ResetJetpackTime();
            }
        }

        // Проверяем джетпак только если он активен
